            ...
            <div className="space-y-6">
              ...
              <div className="relative overflow-x-auto pb-2 custom-scrollbar">
                <div className="flex items-start relative min-w-max px-2">
                  ...
                  <div className="absolute top-6 left-14 right-14 h-[2px] bg-gray-700"></div>
                  ...
                  {moduleFound.map((mod, idx) => {
                    ...
                    return (
                      <div key={mod.id} className="relative z-10 flex flex-col items-center w-28 flex-shrink-0">
                        ...
                        <Link
                          ...
                          className="group transition-all duration-300 flex flex-col items-center w-full"
                        >
                          {/* Círculo do módulo */}
                          <div className={`
                          ...
                          {/* Título do módulo - sempre visível */}
                          <div className={`
                            mt-3 text-center w-full
                            ${isCurrent ? 'text-white font-semibold' : 'text-gray-400'}
                            group-hover:text-white transition-colors
                          `}>
                            <p className="text-xs leading-tight line-clamp-2">{modTrans.title}</p>
                          </div>
                        </Link>
                      </div>
                    );
                ...
                {/* Linha de progresso - calculada com base na largura fixa de cada item (112px = w-28) */}
                <div
                  className="absolute top-6 h-[2px] bg-green-500 transition-all duration-500"
                  style={{
                    left: '3.5rem', // Alinha com o centro do primeiro círculo
                    width: moduleFound.length > 1
                      ? `calc(${(moduleData.order - 1) * 112}px)`
                      : '0px'
                  }}
                ></div>
              </div>
