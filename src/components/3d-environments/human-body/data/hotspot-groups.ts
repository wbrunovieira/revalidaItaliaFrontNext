import type { HotspotGroupItem } from '../types';

// Head hotspots configuration
export const HEAD_HOTSPOTS: HotspotGroupItem[] = [
...
export const TORSO_HOTSPOTS: HotspotGroupItem[] = [
...
export const LEGS_HOTSPOTS: HotspotGroupItem[] = [
...
export const HAND_HOTSPOTS: HotspotGroupItem[] = [
