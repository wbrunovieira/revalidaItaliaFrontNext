...
// 3D Wall Text with shadow effect - secondary color for skeleton environment
export function SkeletonWallText() {
  return (
    <group position={[-5.9, 1.8, 0]} rotation={[0, Math.PI / 2, 0]}>
      ...
      {/* Main text - secondary color */}
      <Text fontSize={0.7} anchorX="center" anchorY="middle" letterSpacing={0.02} fontWeight={700}>
        Revalida Italia
        <meshStandardMaterial color="#3887A6" metalness={0.2} roughness={0.4} />
      </Text>
    </group>
  );
}
