...
import { ModeToggle, ChallengeModeUI, ConsultationModeUI, ScriviModeUI, BonePartsPanel } from './components/ui';
...
export default function SkeletonEnvironment({}: Environment3DProps) {
  ...
  const [skullExpanded, setSkullExpanded] = useState(false);
  const [spineExpanded, setSpineExpanded] = useState(false);
  const [ribcageExpanded, setRibcageExpanded] = useState(false);
  const [pelvisExpanded, setPelvisExpanded] = useState(false);
  const [limbsExpanded, setLimbsExpanded] = useState(false);
  ...
  return (
    <Environment3DContainer title="Scheletro Umano - Osteologia">
      <div
      ...
      >
        ...
        {gameMode === 'study' && (
          <BonePartsPanel
            ...
            setSkullExpanded={setSkullExpanded}
            spineExpanded={spineExpanded}
            setSpineExpanded={setSpineExpanded}
            ribcageExpanded={ribcageExpanded}
            setRibcageExpanded={setRibcageExpanded}
            pelvisExpanded={pelvisExpanded}
            setPelvisExpanded={setPelvisExpanded}
            limbsExpanded={limbsExpanded}
            setLimbsExpanded={setLimbsExpanded}
